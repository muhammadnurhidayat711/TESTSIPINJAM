<?php
// ===============================
// EXPORT PDF PEMINJAMAN KOLAM - SIPINJAM
// ===============================
...
while ($d = $res->fetch_assoc()) {
    ...
    if ($isRecurring) {
        ...
        $notes[] = sprintf(
            ...
            htmlspecialchars($d['jenis_kolam'], ENT_QUOTES, 'UTF-8'),
    ...
    // Kolam: jenis_kolam
    $kolam = htmlspecialchars($d['jenis_kolam'], ENT_QUOTES, 'UTF-8');
    ...
    // PIC: nama_lengkap + nama peminjam (dengan <br>)
...
if ($haveFlagged) {
    ...
    $catatan_html = '
      <div style="margin-top:12px; font-size:9px;">
        <strong>Catatan Jadwal Rutin Kolam:</strong>
...
<body>
  <h2 style="text-align:center;">Laporan Peminjaman Kolam Renang</h2>
...
$filename = 'laporan_peminjaman_kolam_' . $exporter_safe . '_' . date('Ymd_His') . '.pdf';
